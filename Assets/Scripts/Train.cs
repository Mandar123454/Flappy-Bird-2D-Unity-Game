...
public class Train : MonoBehaviour
{
    ...
    public float resetPositionX = 5f; // X position at which the Train will reset
    public float startPositionX = 12f; // X position at which the Train will start
    public float resetDelay = 4.0f; // Delay in seconds before the Train resets
    void Update()
    {
        // Move the Train to the left if it's not resetting
